...
client.on("guildMemberAdd", member => {
  const hosgeldin = new Discord.MessageEmbed()
    .setThumbnail(
      "https://media.discordapp.net/attachments/1116832183798214832/1117049131576340635/standard_2.gif"
    )
     .setAuthor(`Merhaba Sende Aramıza Hoşgeldin`)
    .setDescription("Seni aramız da görmekten onur ve şeref duyuyoruz, Parsher Code.")
   .setColor("#00ff00")
    .addField("**Sunucu Adresimiz**", "[Tıkla ](https://discord.gg/Jrx8hudQ)")
    .addField(
      "**YouTube kanalımız**",
      "[Tıkla ](https://www.youtube.com/channel/UCVqzVgRp10r3RDWz8F9lhyA)"
    )
...
client.on('ready', () => {
  ...
  // Oynuyor Kısmı
    ...
    setInterval(() => {
      ...
      console.log (`Patates    : Gelişmiş bot alt yapı!`);
      console.log ('_________________________________________');
